...
%% Create the table for trials. Each row is a trial
trials = table(d_lens_trials, f_lens_trials, w_lens_trials, R1_trials, R2_trials, gap_lens_trials, r_icos_trials, l_cavity_trials); 
