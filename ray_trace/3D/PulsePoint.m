classdef PulsePoint
    ...
    methods
        ...
        function [P, P2] = spherical_mirror_constraint(P, Mirror, n1, n2)
            ctr = Mirror.ctr;
            R = Mirror.R;
            r = Mirror.r;
            ...
            P.dir = refract_ray(P.pos_prev, P.p, (P.p - ctr), n1, n2); 
            
            % ** CHECK: does this hit the optic
%             if norm([P.p(2) P.p(3)]) <= r
%                 
%                 
%                 
%             else
